...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = React.createClass({
	    ...
	    setSearch: function setSearch(search, startYear, endYear) {
	        this.setState({
	            searchTerm: search,
	            startYear: startYear,
	            endYear: endYear
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { className: 'col-md-12' },
	                React.createElement(Form, { setSearch: this.setSearch })
	            ),
	            React.createElement(
	                'div',
	                { className: 'col-md-12' },
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement("input", { type: "text", className: "form-control text-left", value: this.state.term, onChange: this.handleChange, name: "term", required: true }),
							React.createElement(
								"h4",
								null,
								React.createElement(
							...
							React.createElement("input", { type: "text", className: "form-control text-left", value: this.state.startYear, onChange: this.handleChange, name: "startYear", required: true }),
							React.createElement(
								"h4",
								null,
								React.createElement(
							...
							React.createElement("input", { type: "text", className: "form-control text-left", value: this.state.endYear, onChange: this.handleChange, name: "endYear", required: true }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var saveArticle = function saveArticle(search, i) {
		var article = search;
